...
from openclem.ui.qt import CLEMLaserWidget


class CLEMLaserWidget(CLEMLaserWidget.Ui_Form, QtWidgets.QWidget):
    def __init__(
        self,
        lc: LaserController,
        ...
        super(CLEMLaserWidget, self).__init__(parent=parent)
        self.setupUi(self)
