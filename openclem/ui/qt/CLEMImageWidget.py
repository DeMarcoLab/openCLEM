...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.pushButton_save_image, 5, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.pushButton_acquire_image, 4, 0, 1, 2)
        self.comboBox_imaging_mode = QtWidgets.QComboBox(Form)
        self.comboBox_imaging_mode.setObjectName("comboBox_imaging_mode")
        self.gridLayout.addWidget(self.comboBox_imaging_mode, 1, 1, 1, 1)
