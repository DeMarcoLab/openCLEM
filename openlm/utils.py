...
from openlm.config import BASE_PATH, LOG_PATH
from openlm.structures import MicroscopeSettings, SerialSettings
...
def import_hardware_modules(
    ...
    for hardware_type in hardware_dict:
        ...
        module_name = (
            f"openlm.{hardware_type_str}.{availablility_dict[hardware_name][0]}"
        )
