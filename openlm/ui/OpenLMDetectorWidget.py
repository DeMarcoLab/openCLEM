...
from openlm.ui.qt import OpenLMDetectorWidget


class OpenLMDetectorWidget(OpenLMDetectorWidget.Ui_Form, QtWidgets.QWidget):
    def __init__(
        self,
        ...
        super(OpenLMDetectorWidget, self).__init__(parent=parent)
        self.setupUi(self)
...
def main():
    ...
    image_settings_ui = OpenLMDetectorWidget(viewer=viewer, detector=detector)
