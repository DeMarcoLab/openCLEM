...
from openlm.ui.qt import OpenLMObjectiveWidget
from openlm.objective import ObjectiveStage


class OpenLMObjectiveWidget(OpenLMObjectiveWidget.Ui_Form, QtWidgets.QWidget):
    def __init__(
        self,
        ...
        super(OpenLMObjectiveWidget, self).__init__(parent=parent)
        self.setupUi(self)
...
def main():
    from openlm.objectives.demo.demo import DemoObjective
    obj = DemoObjective("demo")
    viewer = napari.Viewer(ndisplay=2)
    image_settings_ui = OpenLMObjectiveWidget(viewer=viewer, objective=obj)
